...
class Hotel
{
    ...
    static void CustDetails(int i,int rn)
    {
        ...
        if(i<3)
        {
        System.out.print("Enter Second Customer's Name: ");
        name2 = sc.next();
        System.out.print("Enter Mobile number: ");
        contact2=sc.next();
        System.out.print("Enter Gender: ");
    ...
    {
        double amount=0;
        String list[]={"Sandwich","Paasta","Noodles","Coke"};
        System.out.println("\n*******");
        ...
        switch(rtype)
        {
            case 1:
                ...
                break;
            case 2:amount+=3000;
                    System.out.println("Room Charges - "+3000);
                    System.out.println("\nFood Charges:- ");
                    System.out.println("===============");
                     System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                ...
                break;
            case 3:amount+=2200;
                    System.out.println("Room Charges - "+2200);
                    System.out.println("\nFood Charges:- ");
                    System.out.println("===============");
                    System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
